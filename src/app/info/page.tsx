...
import { CURRENT_VERSION, isNewerVersion } from '@/lib/version';
    ...
    const handleUpdateCheck = async () => {
        ...
        try {
            ...
            if (isNewerVersion(CURRENT_VERSION, latestVersion)) {
                setUpdateMessage(`Update available! Version ${latestVersion} is ready to be installed.`);
                 toast({
                    title: "Update Available",
                    description: `Version ${latestVersion} is ready.`,
                    action: <Button onClick={() => window.location.href = latestRelease.html_url}>Update</Button>,
                });
            } else {
            ...
            toast({
                ...
                description: "Could not check for updates. Please check your connection and try again.",
                variant: "destructive",
            });
        } finally {
            setIsChecking(false);
