  ...
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      try {
        ...
        // We fetch all users except the current one initially, and add them back in.
        // This is just one way to handle it, you could also filter on the client.
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[625px] grid-rows-[auto_auto_minmax(0,1fr)] p-0 max-h-[90vh]">
